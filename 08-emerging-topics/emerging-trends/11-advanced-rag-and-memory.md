...
> For the full agent architecture that drives Agentic RAG — including the ReAct loop, memory type taxonomy (in-context, external, procedural, episodic), tool design principles, multi-agent orchestration patterns, and failure modes — see [10-agentic-ai-systems.md](10-agentic-ai-systems.md). This section covers the retrieval-specific mechanics; that file covers the agent loop internals.
