...
> **Companion page:** [Frontier AI Developments 2025](03-frontier-ai-developments-2025.md) covers the same era from a trends lens (multimodal native fusion, long context, agents). Read both if you want model-by-model depth *and* cross-cutting themes without overlap fatigue.
...
> For full GRPO derivation, Best-of-N, ORMs vs PRMs, and test-time compute scaling, see [06-large-reasoning-models.md](06-large-reasoning-models.md). This section focuses on R1's specific training pipeline and how it compares to o1/o3.
