...
> **Companion page:** [2025 Frontier Models — Field Guide](02-2025-frontier-models.md) goes model-by-model (DeepSeek-V3, R1, Llama 4, o3, etc.). This page stays thematic — read the companion when you need named architectures and benchmark comparisons.
...
> For full CLIP math, BLIP-2/Q-Former architecture, LLaVA, VQ-VAE, and audio/video tokenization, see [08-multimodal-architectures.md](08-multimodal-architectures.md). This section focuses on native vs bolt-on fusion and 2025-specific frontier capabilities.
...
> Full SSM derivation (HiPPO matrix, ZOH discretization, S4 DPLR, Mamba hardware scan, RWKV, Jamba): [05-state-space-models.md](05-state-space-models.md)
