...
> This section covers the core metrics used daily. For comprehensive coverage — MCC, Brier score, ECE, NDCG, MAP, MRR, calibration curves, and statistical significance testing — see **[ml-evaluation-metrics.md](12-ml-evaluation-metrics.md)**.
...
A: See [11-imbalanced-data.md](11-imbalanced-data.md) for the full algorithm-level (class weights, threshold tuning, focal loss), data-level (SMOTE, undersampling), and metric-level (PR-AUC over ROC-AUC) breakdown, plus imbalance-ratio rules of thumb.
