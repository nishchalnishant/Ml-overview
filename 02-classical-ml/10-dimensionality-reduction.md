...
**Preprocessing before algorithms sensitive to dimensionality (k-NN, SVM, k-means)?** #flashcard
Preprocessing before algorithms sensitive to dimensionality (k-NN, SVM, k-means)

**Collinear features?** #flashcard
PCA consolidates correlated inputs

**Visualization?** #flashcard
first 2-3 PCs for quick scatter plots

**Compression?** #flashcard
reduce storage while retaining most variance

**Do not use when features are categorical, when non-linear structure dominates, or when components need to be interpretable as original features?** #flashcard
Do not use when features are categorical, when non-linear structure dominates, or when components need to be interpretable as original features

**RBF: $k(x, y) = \exp(-\gamma \|x - y\|^2)$?** #flashcard
captures local non-linear structure; $\gamma$ controls scale

**Polynomial: $k(x, y) = (x \cdot y + c)^p$?** #flashcard
captures interactions up to degree $p$

**Sigmoid?** #flashcard
$k(x, y) = \tanh(\alpha x \cdot y + c)$

**Low perplexity (5-15)?** #flashcard
very local structure; may fragment clusters

**High perplexity (30-50)?** #flashcard
broader neighborhoods; more global-like

**Typical default?** #flashcard
30-50

**Interpreting cluster distance as semantic distance?** #flashcard
meaningless

**Interpreting cluster size as cluster density?** #flashcard
misleading

**Running t-SNE once and treating it as ground truth?** #flashcard
always check multiple random seeds and perplexities

**Using t-SNE for downstream ML tasks?** #flashcard
it has no out-of-sample extension

**Small (2-5)?** #flashcard
very local; may fragment global structure

**Large (50-200)?** #flashcard
global structure preserved; local detail lost

**Small (0.0-0.1)?** #flashcard
tight clusters; good for cluster visualization

**Large (0.5-1.0)?** #flashcard
loose, spread-out embedding; good for exploring global topology
