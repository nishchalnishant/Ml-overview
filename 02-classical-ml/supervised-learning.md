...
> This section covers the core metrics used daily. For comprehensive coverage — MCC, Brier score, ECE, NDCG, MAP, MRR, calibration curves, and statistical significance testing — see **[ml-evaluation-metrics.md](ml-evaluation-metrics.md)**.
