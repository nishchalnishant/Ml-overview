...
subtopic: ""
status: unread
tags: [classicalml, ml, time-series-analysis]
---
...
**Difference once (d=1)?** #flashcard
ΔXt = Xt - Xt-1

**Apply ARMA(2,1) to ΔXt?** #flashcard
Apply ARMA(2,1) to ΔXt
...
**Patch size 16, no overlap?** #flashcard
Patch size 16, no overlap

**Channel independence?** #flashcard
each variate processed separately with shared weights

**Linear complexity in sequence length for long-horizon forecasting?** #flashcard
Linear complexity in sequence length for long-horizon forecasting

**Tokenizes time series values (quantization into bins)?** #flashcard
Tokenizes time series values (quantization into bins)

**Uses T5 language model architecture?** #flashcard
Uses T5 language model architecture

**Trained on 100K+ time series datasets?** #flashcard
Trained on 100K+ time series datasets

**Zero-shot forecasting without task-specific fine-tuning?** #flashcard
Zero-shot forecasting without task-specific fine-tuning

**Universal forecasting model?** #flashcard
Universal forecasting model

**Any frequency, any prediction length?** #flashcard
Any frequency, any prediction length

**Patch-based tokenization (like PatchTST)?** #flashcard
Patch-based tokenization (like PatchTST)

**Handles multivariate series with mixed frequencies?** #flashcard
Handles multivariate series with mixed frequencies

**200M parameter foundation model?** #flashcard
200M parameter foundation model

**Trained on 100B time points (Google Trends, Wikipedia, etc.)?** #flashcard
Trained on 100B time points (Google Trends, Wikipedia, etc.)

**Competitive zero-shot performance on standard benchmarks?** #flashcard
Competitive zero-shot performance on standard benchmarks
