...
- [ ] [Foundations](../01-math-foundations/_flashcards.md) — math, probability, optimization
- [ ] [Classical ML](../03-classical-ml/_flashcards.md) — trees, SVMs, regularization, metrics
- [ ] [Deep Learning](../05-deep-learning-core/_cheatsheet.md) — backprop, attention, training tricks
- [ ] [LLMs](../10-llms/_revision.md) — architecture, RLHF/DPO, LoRA, inference
- [ ] [Production ML](../13-production-ml/_revision.md) — MLOps, drift, deployment strategies
...
**Reference:** [ML System Design](../13-production-ml/11-system-design-and-mlops.md) | [LLM System Design](../15-system-design/02-ml-system-design.md)
...
**Reference:** [Behavioral Questions](../10-llms/interview-notes/14-behavioral-and-scenario-based-questions.md)
...
**Reference:** [ML Coding Patterns](11-ml-coding-patterns.md) | [Algorithms](../03-classical-ml/03-algorithms.md)
