...
**one end-to-end story** you know cold — see [PRE-INTERVIEW-CHECKLIST.md](../03-pre-interview-checklist.md#system-design---know-one-end-to-end-example-cold).
Churn or LTV is the safest choice since it maps directly to existing content:
[17-customer-ltv-prediction.md](../../15-system-design/cases/02-customer-ltv-prediction.md).

---

## 1. Feature Engineering

- [01-foundations/04-data-processing-and-eda.md](../../02-data/02-data-processing-and-eda.md) — leakage, missing data, encoding
- [02-classical-ml/04-data-preprocessing.md](../../02-data/03-data-preprocessing.md)
- [02-classical-ml/09-feature-selection.md](../../02-data/05-feature-selection.md)
- [02-classical-ml/10-dimensionality-reduction.md](../../03-classical-ml/05-dimensionality-reduction.md)
- [02-classical-ml/11-imbalanced-data.md](../../02-data/06-imbalanced-data.md) — churn/fraud-style targets are almost always imbalanced
- [02-classical-ml/20-time-series-analysis.md](../../03-classical-ml/06-time-series-analysis.md) — if telemetry is event/session sequences
- [06-production-ml/system-design/08-feature-store-architecture.md](../../13-production-ml/07-feature-store-architecture.md) — point-in-time correctness, train/serve skew
...
- [03-deep-learning/01-pytorch-fundamentals.md](../../05-deep-learning-core/09-pytorch-fundamentals.md)
- [03-deep-learning/deep-learning-cheatsheet.md](../../05-deep-learning-core/_cheatsheet.md) — backprop, init, batch norm, optimizers
- [03-deep-learning/02-transfer-learning.md](../../05-deep-learning-core/10-transfer-learning.md)
...
- Always compare the DL model against a gradient-boosted tree baseline (XGBoost/LightGBM) — on tabular data GBTs frequently win or tie; being able to say this without being told shows maturity. Reference: [02-classical-ml/05-when-classical-ml-wins.md](../../03-classical-ml/07-when-classical-ml-wins.md).
...
- [02-classical-ml/07-hyperparameter-optimization.md](../../03-classical-ml/08-hyperparameter-optimization.md) — grid vs. random vs. Bayesian (Optuna/Hyperband)
...
- [02-classical-ml/06-cross-validation.md](../../04-evaluation/03-cross-validation.md) — K-fold, stratified, group, time-series splits
...
- **Time-based split** (not random) if predicting future behavior from past — never let future data leak into training folds. Reference: [02-classical-ml/20-time-series-analysis.md](../../03-classical-ml/06-time-series-analysis.md).
...
- [03-deep-learning/deep-learning-cheatsheet.md](../../05-deep-learning-core/_cheatsheet.md) — mixed precision, gradient accumulation, batch norm placement
- [06-production-ml/13-cost-optimization.md](../../12-systems-and-scale/05-cost-optimization.md)
- [03-deep-learning/components/18-llm-serving.md](../../12-systems-and-scale/03-llm-serving.md)

**Two senses of "performance" — cover both:**
1. **Model performance**: regularization (dropout, weight decay, label smoothing), class-weighting or focal loss for imbalance, calibration (see [02-classical-ml/14-calibration-and-uncertainty.md](../../04-evaluation/04-calibration-and-uncertainty.md)) if predicted probabilities feed a downstream decision (e.g. an intervention threshold for at-risk players).
...
- [06-production-ml/01-mlops.md](../../13-production-ml/01-mlops.md)
- [06-production-ml/02-deployment-patterns.md](../../13-production-ml/02-deployment-patterns.md) — batch vs. online serving, shadow deployment, canary
- [06-production-ml/03-model-governance.md](../../13-production-ml/03-model-governance.md)
- [06-production-ml/system-design/01-machine-learning-engineering.md](../../15-system-design/03-machine-learning-engineering.md)
- [06-production-ml/system-design/07-data-engineering-for-ml.md](../../13-production-ml/06-data-engineering-for-ml.md)
- [06-production-ml/system-design/10-model-registry-versioning.md](../../13-production-ml/09-model-registry-versioning.md)
- [06-production-ml/system-design/17-customer-ltv-prediction.md](../../15-system-design/cases/02-customer-ltv-prediction.md) — closest full system-design writeup to a likely EA scenario
- [06-production-ml/system-design/20-fraud-detection-full-system.md](../../15-system-design/cases/05-fraud-detection.md) — if the exercise leans anti-cheat/toxicity
...
8. Report metrics appropriate to the task (ROC-AUC/PR-AUC for imbalanced classification, not accuracy) — reference [02-classical-ml/12-ml-evaluation-metrics.md](../../04-evaluation/01-ml-evaluation-metrics.md).
...
- [ ] [PRE-INTERVIEW-CHECKLIST.md](../03-pre-interview-checklist.md) — 48h/24h/morning-of checklist
...
[ROUND3-tradeoff-drills.md](../05-round3-tradeoff-drills.md) for the tradeoff bank (model choice, serving
