...
**Pair with:** [AI_ML_REVISION_GUIDE.md](../../00-meta/01-ai-ml-systems-and-application.md) for the **night-before** sprint, and [mlops.md](../../13-production-ml/01-mlops.md) when the conversation turns to **production**.
...
- **Day 1-2: ML Logic & Paradoxes**
    - Study: [Fundamentals of Machine Learning](../../03-classical-ml/09-ml-fundamentals.md)
    - Key Concept: Bias-Variance Tradeoff, Occam's Razor, No Free Lunch.
- **Day 3-4: The Data Pipeline**
    - Study: [Data Preprocessing & Feature Engineering](../../02-data/04-feature-engineering.md)
    - Key Concept: Data Leakage prevention, Imputation strategies (MICE/Indicator).
- **Day 5-7: EDA & Statistical Mastery**
    - Study: [Probability & Statistics](../../01-math-foundations/04-probability-and-statistics.md)
...
- **Day 22: ML System Design**
    - Study: [01-day-22-ml-system-design.md](week-3-system-design/01-day-22-ml-system-design.md) & [System Design & MLOps](../../13-production-ml/11-system-design-and-mlops.md)
...
- **Day 26-27: LLM Specialist Training**
    - Study: [LLM Fundamentals](../../10-llms/interview-notes/01-llm-fundamentals.md) & [RAG](../../10-llms/interview-notes/03-retrieval-augmented-generation-rag.md)
...
- **Day 30: Night-Before Sprint**
    - Study: [AI & ML Cheat Sheet](../../00-meta/01-ai-ml-systems-and-application.md) only — no new concepts.
...
1. **[Master Revision Cheat Sheet](../../00-meta/01-ai-ml-systems-and-application.md)**
2. **[Master Q&A Bank](../12-top-ml-questions.md)**
