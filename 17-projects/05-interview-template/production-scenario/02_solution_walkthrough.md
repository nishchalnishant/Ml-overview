...
- Precompute the slow-changing features (merchant risk history, device reputation) into a feature
  ...
  [ROUND3-tradeoff-drills.md](../../../16-interview-prep/05-round3-tradeoff-drills.md#feature-pipeline)).
...
- **Tradeoff bank** → [../../../07-interview-prep/ROUND3-tradeoff-drills.md](../../../16-interview-prep/05-round3-tradeoff-drills.md)
- **Full fraud system design reference** → [../../../06-production-ml/system-design/20-fraud-detection-full-system.md](../../../15-system-design/cases/05-fraud-detection.md)
