...
## <mark style="color:$danger;">1. Linear Methods (Hyperplane/Boundary-based)</mark>

These algorithms create decision boundaries or hyperplanes to separate or predict data.

### <mark style="color:yellow;">Algorithms Overview</mark>
...
_n = samples, p = features_

### <mark style="color:yellow;">Detailed Algorithms</mark>
...
**Interview Question:** _"What if features are correlated?"_

> Use Ridge/Lasso regularization or PCA to handle multicollinearity

***

#### <mark style="color:blue;">Logistic Regression</mark>
...
#### <mark style="color:blue;">Support Vector Machines (SVM/SVR)</mark>
...
#### <mark style="color:blue;">Linear Discriminant Analysis (LDA)</mark>
...
#### <mark style="color:blue;">Principal Component Analysis (PCA)</mark>
...
## <mark style="color:$danger;">2. Tree/Graph-based Methods</mark>

Hierarchical decision-making using tree structures or graph operations.

### <mark style="color:blue;">Algorithms Overview</mark>
...
#### <mark style="color:blue;">Decision Tree</mark>
...
* **Pre-pruning:** Early stopping (max\_depth, min\_samples\_split)
...
* n\_estimators: Number of trees (100-500)
* max\_depth: Tree depth (None or 10-50)
* min\_samples\_split: Minimum samples to split (2-10)
* max\_features: Features per split ('sqrt' for classification, 'log2' or 1/3 for regression)

**Interview Question:** _"Why random subset of features?"_

> Decorrelates trees, prevents all trees from splitting on the same strong features

***

#### <mark style="color:blue;">Gradient Boosting Machines (GBM)</mark>
...
#### <mark style="color:blue;">AdaBoost (Adaptive Boosting)</mark>
...
## <mark style="color:yellow;">3. Probabilistic Methods</mark>
...
#### <mark style="color:blue;">Naive Bayes</mark>
...
#### <mark style="color:blue;">Gaussian Mixture Models (GMM)</mark>
...
#### <mark style="color:blue;">Hidden Markov Models (HMM)</mark>
...
* Transition probabilities: P(state\_t | state\_t-1)
...
## <mark style="color:$danger;">Bias-Variance Trade-off (Enhanced)</mark>

One of the most critical concepts for ML interviews.

### <mark style="color:blue;">Mathematical Decomposition</mark>
...
### <mark style="color:blue;">Algorithm Bias-Variance Characteristics</mark>
...
| Random Forest        | Low      | Low          | More trees, max\_depth              | Increase tree depth        |
...
### <mark style="color:blue;">Practical Solutions</mark>
...
## <mark style="color:$danger;">Interview Quick Reference</mark>
