...
> This section covers the VAE as an autoencoder variant (ELBO, reparameterization trick, KL collapse). For VAEs in the broader generative-modeling context — comparison against GANs/diffusion, and their role as the encoder/decoder in latent diffusion — see [methods/generative-models.md](../methods/08-generative-models.md#1-variational-autoencoders-vaes).
