...
**The problem:** instance segmentation models (Mask R-CNN, Mask2Former — see [segmentation.md](04-segmentation.md) §2) require training on a fixed label taxonomy and produce one mask set per image, with no way to interactively select "just this one object" at inference time.
...
- **Prerequisite: closed-vocabulary detection** → [computer-vision.md](03-computer-vision.md) §4
- **Prerequisite: instance segmentation architectures** → [segmentation.md](04-segmentation.md) §2
- **Vision-language pretraining (CLIP) underlying open-vocabulary grounding** → [computer-vision.md](03-computer-vision.md), [05-llms/applications/09-multimodal.md](../../05-llms/applications/09-multimodal.md)
- **Video-level temporal modeling beyond tracking** → [video-understanding.md](07-video-understanding.md)
