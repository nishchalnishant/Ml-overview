...
> _Full study notes. For the quick-recall version, see [retrieval-augmented-generation-rag-snappy.md](retrieval-augmented-generation-rag-snappy.md)._

See also: [RAG deep dive](../../11-llm-applications/02-rag.md)
