...
> **General ML behavioral bank:** For cross-domain ML stories (train-serve skew, metric tradeoffs, stakeholder conflict), see [Behavioral & Scenario Questions (ML track)](../../16-interview-prep/09-behavioral.md).
