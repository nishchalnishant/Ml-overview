...
> For the basic "how does a dense FFN become a sparse MoE FFN" architectural sketch inside the standard Transformer block, see [03-deep-learning/components/11-transformers.md](../06-architectures/03-transformers.md#mixture-of-experts-moe-ffn). This file goes deeper: router variants, load-balancing loss derivations, capacity factors, expert parallelism, and production models.
