...
| Day | Goal | Activity |
|-----|------|----------|
| **26-27** | Final Review | Re-read "High Priority" files (Supervised, System Design) |
| **28** | Code Refresh | Solve 2-3 medium ML-coding problems |
| **29** | Mock Interview | Practice articulating your projects out loud |
| **30** | Relax | Mental check and logistics verification |
