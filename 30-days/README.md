...
**[Day 1-2: Introduction to Machine Learning](page/day-1-2-introduction-to-machine-learnin.md)**
...
**[Day 3-4: Data Preprocessing Techniques](page/day-3-4-data-preprocessing-techniques.md)**
- Data cleaning and handling missing values
- Feature scaling and normalization techniques

**[Day 5-7: Exploratory Data Analysis (EDA)](page/day-5-7-exploratory-data-analysis-eda.md)**
...
**[Day 8-9: Supervised Learning Algorithms](page-4/day-8-9-supervised-learning-algorithms.md)**
- In-depth study of SVMs, k-NN, and ensemble methods (Random Forests, Gradient Boosting)

**[Day 10-11: Unsupervised Learning Algorithms](page-4/day-10-11-unsupervised-learning-algorithms.md)**
- Clustering techniques (K-means, hierarchical clustering)
- Dimensionality reduction (PCA, t-SNE)

**[Day 12-14: Neural Networks](page-4/day-12-14-neural-networks.md)**
...
**[Day 15-16: Model Evaluation and Selection](page-4/day-15-16-evaluation-metrics.md)**
- Metrics for classification and regression (PR vs ROC, F1 score)
- Cross-validation techniques

**[Day 17-18: Hyperparameter Tuning](page-4/day-17-18-hyperparameter-tuning.md)**
- Grid search vs. random search vs. Bayesian
- Understanding overfitting and underfitting

**[Day 19-21: Specialized Techniques](page-4/day-19-21-specialized-techniques-nlp-cv.md)**
...
**[Day 22: Designing ML Systems](page-3/day-22-ml-system-design.md)**
- Frameworks for building ML systems
- Scalability & production considerations

**[Day 23: Case Studies in ML Applications](page-3/day-23-case-studies.md)**
- Review case studies from Google’s applications (YouTube, Photos, Search)

**[Day 24-25: Behavioral & Soft Skills](page-3/day-24-25-behavioral-soft-skills.md)**
- STAR method, common behavioral questions
- Aligning with company values

**[Day 26-30: Final Review & Mental Prep](page-2/day-26-30-final-prep.md)**
