...
**→ Drill:** [07-interview-prep/ml/19-maths.md](../07-interview-prep/ml/19-maths.md) — eigenvalues, SVD, the PCA/SVD connection, Jacobian and Hessian, PSD matrices, L1/L2 norms.
**→ Applied:** [02-classical-ml/10-dimensionality-reduction.md](../02-classical-ml/10-dimensionality-reduction.md)
...
**→ Drill:** [07-interview-prep/ml/24-statistics-probability-rapid-fire.md](../07-interview-prep/ml/24-statistics-probability-rapid-fire.md) — distributions, Bayes, MLE/MAP, hypothesis testing, confidence intervals, CLT, A/B testing.
**→ Traps:** [07-interview-prep/ml/11-canonical-stats-questions.md](../07-interview-prep/ml/11-canonical-stats-questions.md) — multiple testing, Simpson's paradox, causal design.
**→ Applied:** [02-classical-ml/14-calibration-and-uncertainty.md](../02-classical-ml/14-calibration-and-uncertainty.md)
...
**→ Drill:** [07-interview-prep/ml/03-optimization.md](../07-interview-prep/ml/03-optimization.md) — gradient descent, batch size, learning rate, momentum, Adam/AdamW, vanishing gradients, LR scheduling, optimizer selection.
**→ Applied:** [03-deep-learning/components/06-optimisers.md](../03-deep-learning/components/06-optimisers.md) · [03-deep-learning/components/01-backpropagation.md](../03-deep-learning/components/01-backpropagation.md)
...
**→ Drill:** [07-interview-prep/ml/19-maths.md](../07-interview-prep/ml/19-maths.md) (§7 KL Divergence, §9 Information Theory)
**→ Derivation:** [07-interview-prep/ml/18-math-derivations.md](../07-interview-prep/ml/18-math-derivations.md) (§10 ELBO, §11 KL and cross-entropy)
...
**→ Full derivations:** [07-interview-prep/ml/18-math-derivations.md](../07-interview-prep/ml/18-math-derivations.md)
...
- **Vocabulary for everything above** → [06-ml-glossary.md](06-ml-glossary.md)
- **Putting it to work on real algorithms** → [02-classical-ml/](../02-classical-ml/)
- **Where the calculus becomes backprop** → [03-deep-learning/components/01-backpropagation.md](../03-deep-learning/components/01-backpropagation.md)
