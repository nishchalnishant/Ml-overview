...
> For deeper LLM-specific serving topics (quantization, speculative decoding, batching strategies), see [../llm/01-large-language-model.md](../10-llms/11-large-language-model.md).
