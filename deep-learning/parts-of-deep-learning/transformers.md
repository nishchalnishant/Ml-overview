...
#### <mark style="color:$danger;">What is a Transformer?</mark>
...
#### <mark style="color:$danger;">Why Was It a Revolution? The Problem it Solved</mark>
...
#### <mark style="color:$danger;">The Core Architecture: 3 Key Ideas</mark>
...
1.  <mark style="color:blue;">Self-Attention (The Engine):</mark>
...
2.  <mark style="color:blue;">Multi-Head Attention:</mark>
...
3.  <mark style="color:blue;">Positional Encoding:</mark>
...
#### <mark style="color:$danger;">Types of Transformers</mark>
...
<mark style="color:blue;">**1. Encoder-Only (e.g., BERT, RoBERTa)**</mark>
...
<mark style="color:blue;">**2. Decoder-Only (e.g., GPT series, LLaMA, Claude)**</mark>
...
<mark style="color:blue;">**3. Encoder-Decoder (e.g., T5, BART, the original)**</mark>
...
#### <mark style="color:red;">Pros and Cons</mark>
...
<mark style="color:blue;">\*\* Cons\*\*</mark>
