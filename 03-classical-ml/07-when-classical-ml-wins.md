...
**The mechanics**: see the per-model calibration behavior table in [14-calibration-and-uncertainty.md](../04-evaluation/04-calibration-and-uncertainty.md).
