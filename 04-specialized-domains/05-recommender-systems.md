...
> For the classical matrix-factorization math (ALS vs SGD, implicit-feedback WALS) in more derivation-heavy form, see [02-classical-ml/02-recommender-systems-classical.md](../02-classical-ml/02-recommender-systems-classical.md) — this section focuses on the neighborhood-CF intuition and its role in the broader system.
