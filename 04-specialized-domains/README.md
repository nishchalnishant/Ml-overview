...
[../03-deep-learning/methods/03-computer-vision.md](../03-deep-learning/methods/03-computer-vision.md)
...
[../03-deep-learning/methods/01-nlp-fundamentals.md](../03-deep-learning/methods/01-nlp-fundamentals.md)
...
[rl-fundamentals.md](01-rl-fundamentals.md)
...
Additional files:
- [rl-advanced.md](02-rl-advanced.md): Imitation learning (BC, DAgger, GAIL), Inverse RL (MaxEntropy IRL), Multi-agent RL (QMIX, MAPPO, self-play), Hierarchical RL (Options, HER, Feudal RL), Meta-RL (MAML, RL²), Curriculum learning, Sim-to-real transfer, Offline RL (CQL, IQL, Decision Transformer).
- [rl-model-based.md](03-rl-model-based.md): Model-free vs model-based tradeoffs, learned world models (Dyna, MCTS, DreamerV3, MuZero), connection to LLM reasoning (o1-style MCTS, Process Reward Models).
...
[speech-audio.md](07-speech-audio.md)
...
[../03-deep-learning/methods/09-time-series.md](../03-deep-learning/methods/09-time-series.md)
...
[recommender-systems.md](05-recommender-systems.md)
...
[graph-neural-networks.md](06-graph-neural-networks.md)
...
[tabular-data.md](04-tabular-data.md)
