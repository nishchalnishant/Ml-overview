...
> Read [16-model-compression.md](01-model-compression.md) first for the conceptual overview (why each technique exists, when to reach for it). This file is the math/code deep-dive on quantization and pruning specifically.
