...
> For the straight-through-estimator implementation and PTQ-vs-QAT tradeoff table, see [17-quantization-pruning-detailed.md § 4](02-quantization-pruning.md#4-quantization-aware-training-qat).
...
> For the Hessian-based algorithm, AWQ's scale-search formula, and full code, see [17-quantization-pruning-detailed.md § 3](02-quantization-pruning.md#3-post-training-quantization-ptq).
...
> For Iterative Magnitude Pruning and Movement Pruning formulas and code, see [17-quantization-pruning-detailed.md § 7](02-quantization-pruning.md#7-pruning).
