...
- **Pre-written defaults + flip conditions in a production-system framing (fraud/ranking/etc.)** → [ROUND3-tradeoff-drills.md](ROUND3-tradeoff-drills.md)
- **LLM-specific deep-dive material to ground your reasoning** → [09-study-plans/week-5-llm-deep-dive/README.md](../09-study-plans/week-5-llm-deep-dive/README.md)
