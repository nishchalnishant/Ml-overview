...
> **LLM-heavy behavioral bank:** For GenAI-specific scenarios (RAG failures, prompt injection incidents, alignment tradeoffs), see [Behavioral & Scenario Questions (LLM track)](../../05-llms/interview-notes/behavioral-and-scenario-based-questions.md) or the snappy version [here](../../05-llms/interview-notes/behavioral-and-scenario-based-questions-snappy.md).
...
### The concrete business or technical context
- Direct Answer: The concrete business or technical context
- Why: This matters because it tells you how to reason about the concrete business or technical context.
- Pitfall: Don't answer "The concrete business or technical context" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: The concrete business or technical context

### Why the situation was challenging
- Direct Answer: what made it non-obvious
- Why: This matters because it tells you how to reason about why the situation was challenging.
- Pitfall: Don't answer "Why the situation was challenging" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: what made it non-obvious

### Your role in the organization at the time
- Direct Answer: Your role in the organization at the time
- Why: This matters because it tells you how to reason about your role in the organization at the time.
- Pitfall: Don't answer "Your role in the organization at the time" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: Your role in the organization at the time

### Over-explaining the domain (one sentence of context is enough)
- Direct Answer: Over-explaining the domain (one sentence of context is enough)
- Why: This matters because it tells you how to reason about over-explaining the domain (one sentence of context is enough).
- Pitfall: Don't answer "Over-explaining the domain (one sentence of context is enough)" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: Over-explaining the domain (one sentence of context is enough)

### Starting with the outcome (it removes tension from the story)
- Direct Answer: Starting with the outcome (it removes tension from the story)
- Why: This matters because it tells you how to reason about starting with the outcome (it removes tension from the story).
- Pitfall: Don't answer "Starting with the outcome (it removes tension from the story)" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: Starting with the outcome (it removes tension from the story)

### Generic framing ("it was a typical ML project where...")
- Direct Answer: Generic framing ("it was a typical ML project where...")
- Why: This matters because it tells you how to reason about generic framing ("it was a typical ml project where...").
- Pitfall: Don't answer "Generic framing ("it was a typical ML project where...")" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: Generic framing ("it was a typical ML project where...")

### What you were specifically responsible for delivering
- Direct Answer: What you were specifically responsible for delivering
- Why: This matters because it tells you how to reason about what you were specifically responsible for delivering.
- Pitfall: Don't answer "What you were specifically responsible for delivering" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: What you were specifically responsible for delivering

### What the constraint was (time, compute, labels, stakeholder expectations)
- Direct Answer: What the constraint was (time, compute, labels, stakeholder expectations)
- Why: This matters because it tells you how to reason about what the constraint was (time, compute, labels, stakeholder expectations).
- Pitfall: Don't answer "What the constraint was (time, compute, labels, stakeholder expectations)" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: What the constraint was (time, compute, labels, stakeholder expectations)

### What ambiguity existed at the start
- Direct Answer: What ambiguity existed at the start
- Why: This matters because it tells you how to reason about what ambiguity existed at the start.
- Pitfall: Don't answer "What ambiguity existed at the start" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: What ambiguity existed at the start

### Oversimplifying ("my task was to improve the model")
- Direct Answer: Oversimplifying ("my task was to improve the model")
- Why: This matters because it tells you how to reason about oversimplifying ("my task was to improve the model").
- Pitfall: Don't answer "Oversimplifying ("my task was to improve the model")" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: Oversimplifying ("my task was to improve the model")

### Implying you had more resources or clarity than you did
- Direct Answer: Implying you had more resources or clarity than you did
- Why: This matters because it tells you how to reason about implying you had more resources or clarity than you did.
- Pitfall: Don't answer "Implying you had more resources or clarity than you did" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: Implying you had more resources or clarity than you did

### Your diagnostic process
- Direct Answer: how you narrowed down the root cause
- Why: This matters because it tells you how to reason about your diagnostic process.
- Pitfall: Don't answer "Your diagnostic process" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: how you narrowed down the root cause

### The options you considered and why you rejected alternatives
- Direct Answer: The options you considered and why you rejected alternatives
- Why: This matters because it tells you how to reason about the options you considered and why you rejected alternatives.
- Pitfall: Don't answer "The options you considered and why you rejected alternatives" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: The options you considered and why you rejected alternatives

### A specific technical decision with its reasoning
- Direct Answer: A specific technical decision with its reasoning
- Why: This matters because it tells you how to reason about a specific technical decision with its reasoning.
- Pitfall: Don't answer "A specific technical decision with its reasoning" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: A specific technical decision with its reasoning

### A moment where you had to choose between options with real tradeoffs
- Direct Answer: A moment where you had to choose between options with real tradeoffs
- Why: This matters because it tells you how to reason about a moment where you had to choose between options with real tradeoffs.
- Pitfall: Don't answer "A moment where you had to choose between options with real tradeoffs" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: A moment where you had to choose between options with real tradeoffs

### If applicable
- Direct Answer: how you worked with others to unblock yourself
- Why: This matters because it tells you how to reason about if applicable.
- Pitfall: Don't answer "If applicable" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: how you worked with others to unblock yourself

### Listing steps without explaining why each was chosen
- Direct Answer: Listing steps without explaining why each was chosen
- Why: This matters because it tells you how to reason about listing steps without explaining why each was chosen.
- Pitfall: Don't answer "Listing steps without explaining why each was chosen" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: Listing steps without explaining why each was chosen

### Jumping from "I noticed a problem" to "I fixed it" without showing the reasoning
- Direct Answer: Jumping from "I noticed a problem" to "I fixed it" without showing the reasoning
- Why: This matters because it tells you how to reason about jumping from "i noticed a problem" to "i fixed it" without showing the reasoning.
- Pitfall: Don't answer "Jumping from "I noticed a problem" to "I fixed it" without showing the reasoning" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: Jumping from "I noticed a problem" to "I fixed it" without showing the reasoning

### Giving the impression you knew the answer immediately
- Direct Answer: Giving the impression you knew the answer immediately
- Why: This matters because it tells you how to reason about giving the impression you knew the answer immediately.
- Pitfall: Don't answer "Giving the impression you knew the answer immediately" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: Giving the impression you knew the answer immediately

### A quantitative outcome where possible
- Direct Answer: A quantitative outcome where possible
- Why: This matters because it tells you how to reason about a quantitative outcome where possible.
- Pitfall: Don't answer "A quantitative outcome where possible" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: A quantitative outcome where possible

### The business relevance of the technical metric
- Direct Answer: The business relevance of the technical metric
- Why: This matters because it tells you how to reason about the business relevance of the technical metric.
- Pitfall: Don't answer "The business relevance of the technical metric" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: The business relevance of the technical metric

### Honest acknowledgment if the result was partial or mixed
- Direct Answer: Honest acknowledgment if the result was partial or mixed
- Why: This matters because it tells you how to reason about honest acknowledgment if the result was partial or mixed.
- Pitfall: Don't answer "Honest acknowledgment if the result was partial or mixed" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: Honest acknowledgment if the result was partial or mixed

### Only technical metrics with no business framing
- Direct Answer: Only technical metrics with no business framing
- Why: This matters because it tells you how to reason about only technical metrics with no business framing.
- Pitfall: Don't answer "Only technical metrics with no business framing" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: Only technical metrics with no business framing

### Inflating results
- Direct Answer: Inflating results
- Why: This matters because it tells you how to reason about inflating results.
- Pitfall: Don't answer "Inflating results" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: Inflating results

### Claiming the outcome was a complete success if it was not
- Direct Answer: Claiming the outcome was a complete success if it was not
- Why: This matters because it tells you how to reason about claiming the outcome was a complete success if it was not.
- Pitfall: Don't answer "Claiming the outcome was a complete success if it was not" by naming the concept alone; state the mechanism and tradeoff.
- Interview line: Say: Claiming the outcome was a complete success if it was not
